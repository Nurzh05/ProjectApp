package com.example.project1.captcha;
...
public class CreateAssessment {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String projectID = "feisty-flow-400408";
        String recaptchaKey = "6LcYyskpAAAAAL54Kx2OstUuwYcG87r_DzMl_kDs";
        String token = "6LcYyskpAAAAAGtF7OBLSuf1YF6iwSOgIyC2DhSg";
